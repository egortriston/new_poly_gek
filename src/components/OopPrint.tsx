...
function OopPaper({programId}:{programId:string}) {
 ...
 return <article className="document-paper oop-print-paper">
  ...
  <div className="document-demo">Демонстрационный макет · не является официальным документом</div>
 </article>;
}
