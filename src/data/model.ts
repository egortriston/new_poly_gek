export type Person = { id: string; name: string; position: string; organization: string; degree: string; rank: string; kind: 'internal' | 'external'; initials: string; color: string; chairmanProgramIds?: string[] };
