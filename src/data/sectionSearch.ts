...
{"title":"Матрица ОПК","path":"/oop/data/directions/opk","group":"Исходные для направлений","keywords":"направление подготовки профессиональная деятельность компетенции"},
 ...
 {title:'Проверка статуса ООП',path:'/oop/status',group:'Разработка и корректировка ООП',keywords:'состояние готовность программ'},
  ...
  { title: 'Формирование комиссий', path: '/commissions', group: 'ГЭК', keywords: 'состав члены формирование гэк список комиссий просмотр создать комиссию создать гэк' },
  { title: 'Печать документов ГЭК', path: '/gek/documents', group: 'ГЭК', keywords: 'документы шаблоны распечатать приказ выгрузка формирование и печать' },
  ...
  { title: 'Структура института', path: '/data/structure', group: 'Исходные данные', keywords: 'подразделения преподаватели школы ипмэит структура университета' },
  ...
  { title: 'Учебные справочники', path: '/data/education', group: 'Исходные данные', keywords: 'образование учебные справочники' },
  { title: 'Направления подготовки', path: '/data/catalog/directions', group: 'Исходные данные · Учебные справочники', keywords: 'направление код специальности' },
  { title: 'Образовательные программы', path: '/data/catalog/programs', group: 'Исходные данные · Учебные справочники', keywords: 'программа профиль профили оп' },
  { title: 'Дисциплины', path: '/data/catalog/disciplines', group: 'Исходные данные · Учебные справочники', keywords: 'предметы курсы дисциплина' },
